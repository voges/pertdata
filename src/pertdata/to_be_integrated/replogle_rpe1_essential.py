"""Preprocessing for the Replogle RPE1 Essential dataset."""
...
def download_raw_data(dir_path: str) -> None:
    ...
    download_file(
        ...
        path=os.path.join(dir_path, "rpe1_raw_singlecell_01.h5ad"),
    )
...
def load_raw_data(dir_path: str) -> sc.AnnData:
    ...
    Returns:
        The AnnData object.
    """
    adata = sc.read_h5ad(filename=os.path.join(dir_path, "rpe1_raw_singlecell_01.h5ad"))
    return adata
